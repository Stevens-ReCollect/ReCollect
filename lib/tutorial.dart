...
class TutorialState extends State<Tutorial> {
  ...
  List stepDesc = [
    "Upload memories via pictures, videos, and audio by tapping Create New Memory in the home page.",
    ...
    _nextButton() {
      ...
      return ElevatedButton(
          style: ElevatedButton.styleFrom(
              maximumSize: Size.fromWidth(0.5 * deviceWidth),
    ...
    _backButton() {
      if (step > 0) {
        return ElevatedButton(
            style: ElevatedButton.styleFrom(
                maximumSize: Size.fromWidth(0.5 * deviceWidth),
                primary: ColorConstants.hintText,
                padding: EdgeInsets.all(20),
                alignment: Alignment.center,
                textStyle: TextStyle(
                    fontSize: 0.7 *
