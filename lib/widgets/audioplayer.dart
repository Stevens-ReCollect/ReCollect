...
class AudioPlayerWidget extends StatefulWidget {
  const AudioPlayerWidget(this.description, this.title, this.asset, this.doc_id, {Key? key}) : super(key: key);
...
class AudioPlayerState extends State <AudioPlayerWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    format(Duration d) => d.toString().split('.').first.padLeft(8, "0"); //duration format
        ...
        Container(
            ...
            FutureBuilder<dynamic>( // to get current position and duration
              ...
              builder: (context, snapshot1) {
                ...
                return Row(children: [
                Text(format(Duration(seconds:snapshot1.data)) + '/' + format(Duration(seconds:snapshot2.data)).padLeft(8, "0")),
                Slider.adaptive(
                  value: double.parse(snapshot1.data.toString()), 
                  max: double.parse(snapshot2.data.toString()),
